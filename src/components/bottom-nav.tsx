...
export function BottomNav({ active }: Props) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 px-3 pb-3 pt-2 md:hidden">
      <div className="mx-auto w-full max-w-[720px] rounded-2xl border border-neutral-200 bg-white/95 p-2 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-white/90 dark:border-neutral-700 dark:bg-neutral-900/95">
